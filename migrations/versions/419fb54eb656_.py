...
Revision ID: 419fb54eb656
Revises: 
Create Date: 2019-09-18 16:16:34.752427
...
def upgrade():
    ...
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('excerp_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['excerp_id'], ['excerpts.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
